...
static const char *fonts[]          = { "Cascadia Mono NF:size=12", "Source Han Sans SC:size=12" };
static const char col_bg[]       = "#131822";
static const char col_fg[]       = "#C1E8FF";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_fg, col_bg, col_bg }, // 普通状态下的颜色方案
	[SchemeSel]  = { col_fg, col_bg, col_fg  }, // 选中状态下的颜色方案
};
...
//	{ MODKEY,                       XK_comma,  			focusmon,      	{.i = -1 } }, // 多显示其聚焦
//	{ MODKEY,                       XK_period, 			focusmon,       {.i = +1 } },
//	{ MODKEY|ShiftMask,             XK_comma,  			tagmon,         {.i = -1 } }, // 将窗口移动到其他显示器
